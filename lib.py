...
def unpack_args(args):
    ...
    if len(args) == 1: # only the mode is provided
        print("No instruction where provided, aborting ...")
        os.abort()
    elif len(args) == 2: # mode and main file, 
        print("No name where provided to build the file, aborting...")
